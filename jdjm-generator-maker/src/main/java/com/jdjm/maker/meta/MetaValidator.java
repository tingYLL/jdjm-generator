...
import com.jdjm.maker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "jdjm");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.jdjm");
